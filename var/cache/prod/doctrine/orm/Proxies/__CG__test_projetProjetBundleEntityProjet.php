 ...
 */
class Projet extends \test_projet\ProjetBundle\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'test_projet\\ProjetBundle\\Entity\\Projet' . "\0" . 'id', '' . "\0" . 'test_projet\\ProjetBundle\\Entity\\Projet' . "\0" . 'objectifs', '' . "\0" . 'test_projet\\ProjetBundle\\Entity\\Projet' . "\0" . 'utilisateurs'];
        }
