 ...
 */
class Objectif extends \test_projet\ProjetBundle\Entity\Objectif implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'test_projet\\ProjetBundle\\Entity\\Objectif' . "\0" . 'id', '' . "\0" . 'test_projet\\ProjetBundle\\Entity\\Objectif' . "\0" . 'pere', '' . "\0" . 'test_projet\\ProjetBundle\\Entity\\Objectif' . "\0" . 'taches'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Objectif $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setUtilisateurs(\test_projet\UserBundle\Entity\User $utilisateur = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUtilisateurs', [$utilisateur]);

        return parent::setUtilisateurs($utilisateur);
    }
    ...
    public function addObjectif(\test_projet\ProjetBundle\Entity\Objectif $objectif)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addObjectif', [$objectif]);

        return parent::addObjectif($objectif);
    }
    ...
    public function removeObjectif(\test_projet\ProjetBundle\Entity\Objectif $objectif)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeObjectif', [$objectif]);

        return parent::removeObjectif($objectif);
    }
